  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Något gick fel. Prova att uppdatera eller gå tillbaka till startsidan.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "God man – Enkel administration" },
      {
        ...
        content:
          "Håll ordning på uppdraget som god man eller förvaltare — snabbt, tryggt och mobilanpassat.",
      },
